...
def Preprocess(j):
    ...
    train=pd.read_csv("D:/data/carset_ex_0818_2/carset_ex_gear/carset_ex_%s_gear.csv"%j)  ##"D:/data/carset_ex_drFalse/carset_ex_2_drFalse.csv"
    ...
    test=pd.read_csv("D:/data/carset_ex_0818_2/predict_price_series_gear/predict_price_series_%s_gear.csv"%j)
...
def run_test(precision,test,features,target,j):
    print 'testing...'
    model=load_model('D:/data/carset_ex_0818_2/model/model_%s.pkl'%j)  #carset_ex_77
    ...
    df=pd.read_csv("D:/data/carset_ex_0818_2/predict_price_series_gear/predict_price_series_%s_gear.csv"%j)  #"C:/danhua/carset_ex_77/predict_price_series/predict_price_series_77.csv"
    df["y_predict"]=y_predict
    df.to_csv('D:/data/carset_ex_0818_2/test/predict_price_series_%s.csv'%j,index=False) #carset_ex_77
    return erroNum,allNum,precision1

def getResult(j):
    df=pd.read_csv('D:/data/carset_ex_0818_2/test/predict_price_series_%s.csv'%j)
    y_result=[]
    ...
    df.to_csv('D:/data/carset_ex_0818_2/test_discount/predict_price_series_%s_discount.csv'%j,index=False)
